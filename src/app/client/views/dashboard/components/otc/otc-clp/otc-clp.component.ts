...
@Component({
  selector: 'app-otc-clp',
  templateUrl: './otc-clp.component.html',
  styleUrl: './otc-clp.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class OtcClpComponent {
  ...
  // clip Route
  ClipOtc(){
    this.router.navigate(['/dashboard/otc/clp']);
  }
  usdtOtc(){
    this.router.navigate(['/dashboard/otc/usdt']);
  }
  BuySell() {
