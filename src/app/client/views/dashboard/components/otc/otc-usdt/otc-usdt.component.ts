...
@Component({
  selector: 'app-otc-usdt',
  templateUrl: './otc-usdt.component.html',
  styleUrl: './otc-usdt.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class OtcUsdtComponent {
  ...
  BuySell() {
    ...
    // clip Route
    clipOtc(){
      this.router.navigate(['/dashboard/otc']);
    }
    usdtOtc(){
